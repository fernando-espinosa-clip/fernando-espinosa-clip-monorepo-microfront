export const cards = [
    ...
    {
        description: "Then under agreement so guy party away into really maybe road spring local inside history financial exactly soon indeed nice official vote here left million film.",
    ...
    {
        description: "Range under not themselves fear social risk star policy behind say then beat focus standard simple month practice class carry wonder appear age world history view why.",
    ...
    {
        description: "Soon different phone free police process role though move go recognize able television executive specific nature give all its only good yes prevent issue.",
    ...
    {
        description: "Together threat whether cell our particularly society heavy ago watch foot lead part idea election professor issue suddenly task maintain create work determine blue one share health feeling husband difference finally lose city forget whose.",
    ...
    {
        description: "Fly threat I quality suffer wear throw strong recent today treat product director daughter crime approach spend gun inside popular teacher statement them car.",
    ...
    {
        description: "Similar too different newspaper offer crime management turn decide themselves future baby hotel compare.",
    ...
    {
        description: "Field statement sense instead cultural ball attention quality window current indeed century large approach operation resource everyone particular establish American conference.",
